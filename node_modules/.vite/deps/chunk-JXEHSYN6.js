...
// node_modules/.pnpm/@dojoengine+core@1.8.0_bufferutil@4.0.9_typescript@5.9.2_utf-8-validate@5.0.10/node_modules/@dojoengine/core/dist/index.js
...
var parseDojoCall = (manifest, nameSpace, call) => {
  if ("contractName" in call) {
    ...
    return {
      ...
      calldata: new CallData(contract2.abi).compile(
        call.entrypoint,
        call.calldata
      ),
...
var DojoProviderBase = class extends Provider {
  ...
  initializeActionMethods() {
    ...
    for (const contract2 of this.manifest.contracts) {
      ...
      const abiItems = Array.isArray(contract2.abi) ? contract2.abi : [];
      for (const systemName of contract2.systems) {
        ...
        host[systemName] = async (account, args) => {
...
var abiItem = external_exports.union([
  external_exports.object({
    type: external_exports.literal("impl"),
    name: external_exports.string(),
    interface_name: external_exports.string()
  }),
  external_exports.object({
    type: external_exports.literal("struct"),
    name: external_exports.string(),
    members: external_exports.array(external_exports.object({ name: external_exports.string(), type: external_exports.string() }))
  }),
  external_exports.object({
    type: external_exports.literal("enum"),
    name: external_exports.string(),
    variants: external_exports.array(external_exports.object({ name: external_exports.string(), type: external_exports.string() }))
  }),
  external_exports.object({
    type: external_exports.literal("interface"),
    name: external_exports.string(),
    items: external_exports.array(
      external_exports.object({
        ...
        inputs: external_exports.array(
          external_exports.object({ name: external_exports.string(), type: external_exports.string() })
        ),
        outputs: external_exports.array(external_exports.object({ type: external_exports.string() })),
        state_mutability: external_exports.string()
      })
    )
  }),
  external_exports.object({
    type: external_exports.literal("constructor"),
    name: external_exports.string(),
    inputs: external_exports.array(external_exports.object({ name: external_exports.string(), type: external_exports.string() }))
  }),
  external_exports.object({
    type: external_exports.literal("event"),
    name: external_exports.string(),
    kind: external_exports.literal("struct"),
    members: external_exports.array(
      external_exports.object({ name: external_exports.string(), type: external_exports.string(), kind: external_exports.string() })
    )
  }),
  external_exports.object({
    type: external_exports.literal("event"),
...
var generalFields = external_exports.object({
  class_hash: external_exports.string(),
  name: external_exports.string(),
  abi: external_exports.array(abiItem)
});
var world = generalFields.extend({
  kind: external_exports.literal("WorldContract"),
  address: external_exports.string(),
  transaction_hash: external_exports.string(),
  block_number: external_exports.number(),
  seed: external_exports.string(),
  metadata: external_exports.object({
    rpc_url: external_exports.string()
  })
});
var base = generalFields.extend({
  kind: external_exports.literal("Class"),
  abi: external_exports.literal(null)
});
var contract = generalFields.extend({
  kind: external_exports.literal("DojoContract"),
  address: external_exports.string(),
  reads: external_exports.array(external_exports.unknown()),
  writes: external_exports.array(external_exports.unknown()),
  computed: external_exports.array(external_exports.unknown())
});
var model = generalFields.extend({
  kind: external_exports.literal("DojoModel"),
  members: external_exports.array(
    external_exports.object({
      name: external_exports.string(),
      type: external_exports.string(),
      key: external_exports.boolean()
    })
  )
});
var manifestSchema = external_exports.object({
  world,
  base,
  contracts: external_exports.array(contract),
  models: external_exports.array(model)
});
...
//# sourceMappingURL=chunk-JXEHSYN6.js.map
