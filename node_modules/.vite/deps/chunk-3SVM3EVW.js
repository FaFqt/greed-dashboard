import {
  ...
  parseAbiParameters,
  size
} from "./chunk-BQ5FL6X7.js";
import {
  eventemitter3_default
} from "./chunk-NEBKCECC.js";
import {
  Chi,
  HashMD,
  Maj
} from "./chunk-A5DEW6O6.js";
import {
  keccak_256
...
// node_modules/.pnpm/@starknet-react+core@5.0.3_bufferutil@4.0.9_get-starknet-core@4.0.0_react@18.3.1_starknet@8.5_ny56ldlfthp5up6fxfh57y5gz4/node_modules/@starknet-react/core/dist/index.js
...
// node_modules/.pnpm/@starknet-react+chains@5.0.3/node_modules/@starknet-react/chains/dist/index.js
var devnet = {
...
function matchQuery(filters, query) {
  ...
  if (queryKey14) {
    if (exact) {
      if (query.queryHash !== hashQueryKeyByOptions(queryKey14, query.options)) {
        return false;
      }
    } else if (!partialMatchKey(query.queryKey, queryKey14)) {
      return false;
    }
  }
  if (type !== "all") {
...
function matchMutation(filters, mutation) {
  const { exact, status, predicate, mutationKey: mutationKey4 } = filters;
  if (mutationKey4) {
    if (!mutation.options.mutationKey) {
      return false;
    }
    if (exact) {
      if (hashKey(mutation.options.mutationKey) !== hashKey(mutationKey4)) {
        return false;
      }
    } else if (!partialMatchKey(mutation.options.mutationKey, mutationKey4)) {
      return false;
    }
  }
...
function hashQueryKeyByOptions(queryKey14, options) {
  const hashFn = options?.queryKeyHashFn || hashKey;
  return hashFn(queryKey14);
}
function hashKey(queryKey14) {
...
var Query = class extends Removable {
  ...
  async fetch(options, fetchOptions) {
    ...
    const fetchFn = () => {
      const queryFn13 = ensureQueryFn(this.options, fetchOptions);
      ...
      return queryFn13(queryFnContext);
    };
  ...
  return {
    onFetch: (context, query) => {
      ...
      const fetchFn = async () => {
        ...
        const queryFn13 = ensureQueryFn(context.options, context.fetchOptions);
        const fetchPage = async (data, param, previous) => {
          ...
          const queryFnContext = createQueryFnContext();
          const page = await queryFn13(queryFnContext);
...
var QueryCache = class extends Subscribable {
  ...
  #queries;
  build(client, options, state) {
    const queryKey14 = options.queryKey;
    const queryHash = options.queryHash ?? hashQueryKeyByOptions(queryKey14, options);
    ...
    if (!query) {
      query = new Query({
        ...
        state,
        defaultOptions: client.getQueryDefaults(queryKey14)
      });
      this.add(query);
    }
    return query;
...
var QueryClient = class {
   ...
   */
  getQueryData(queryKey14) {
    const options = this.defaultQueryOptions({ queryKey: queryKey14 });
  ...
  getQueriesData(filters) {
    return this.#queryCache.findAll(filters).map(({ queryKey: queryKey14, state }) => {
      const data = state.data;
      return [queryKey14, data];
    });
  }
  setQueryData(queryKey14, updater, options) {
    const defaultedOptions = this.defaultQueryOptions({ queryKey: queryKey14 });
  ...
  setQueriesData(filters, updater, options) {
    return notifyManager.batch(
      () => this.#queryCache.findAll(filters).map(({ queryKey: queryKey14 }) => [
        queryKey14,
        this.setQueryData(queryKey14, updater, options)
      ])
    );
  }
  getQueryState(queryKey14) {
    const options = this.defaultQueryOptions({ queryKey: queryKey14 });
  ...
  setQueryDefaults(queryKey14, options) {
    this.#queryDefaults.set(hashKey(queryKey14), {
      queryKey: queryKey14,
      defaultOptions: options
    });
  }
  getQueryDefaults(queryKey14) {
    const defaults = [...this.#queryDefaults.values()];
    const result = {};
    defaults.forEach((queryDefault) => {
      if (partialMatchKey(queryKey14, queryDefault.queryKey)) {
        Object.assign(result, queryDefault.defaultOptions);
      }
    });
    return result;
  }
  setMutationDefaults(mutationKey4, options) {
    this.#mutationDefaults.set(hashKey(mutationKey4), {
      mutationKey: mutationKey4,
      defaultOptions: options
    });
  }
  getMutationDefaults(mutationKey4) {
    const defaults = [...this.#mutationDefaults.values()];
    const result = {};
    defaults.forEach((queryDefault) => {
      if (partialMatchKey(mutationKey4, queryDefault.mutationKey)) {
        Object.assign(result, queryDefault.defaultOptions);
      }
    });
    return result;
...
// node_modules/.pnpm/viem@2.37.8_bufferutil@4.0.9_typescript@5.9.2_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_esm/utils/formatters/transaction.js
var transactionType = {
  "0x0": "legacy",
  "0x1": "eip2930",
  "0x2": "eip1559",
...
// node_modules/.pnpm/viem@2.37.8_bufferutil@4.0.9_typescript@5.9.2_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_esm/utils/formatters/block.js
...
// node_modules/.pnpm/viem@2.37.8_bufferutil@4.0.9_typescript@5.9.2_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_esm/actions/public/getTransactionCount.js
...
// node_modules/.pnpm/viem@2.37.8_bufferutil@4.0.9_typescript@5.9.2_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_esm/constants/blob.js
...
// node_modules/.pnpm/viem@2.37.8_bufferutil@4.0.9_typescript@5.9.2_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_esm/utils/formatters/log.js
...
// node_modules/.pnpm/viem@2.37.8_bufferutil@4.0.9_typescript@5.9.2_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_esm/actions/wallet/sendTransaction.js
var supportsWalletNamespace = new LruMap(128);

// node_modules/.pnpm/viem@2.37.8_bufferutil@4.0.9_typescript@5.9.2_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_esm/utils/formatters/transactionReceipt.js
var receiptStatuses = {
  "0x0": "reverted",
  "0x1": "success"
};
...
// node_modules/.pnpm/viem@2.37.8_bufferutil@4.0.9_typescript@5.9.2_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_esm/actions/wallet/sendCalls.js
var fallbackTransactionErrorMagicIdentifier = numberToHex(0, {
  size: 32
});

// node_modules/.pnpm/viem@2.37.8_bufferutil@4.0.9_typescript@5.9.2_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_esm/utils/promise/withDedupe.js
...
// node_modules/.pnpm/viem@2.37.8_bufferutil@4.0.9_typescript@5.9.2_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_esm/utils/nonceManager.js
...
// node_modules/.pnpm/viem@2.37.8_bufferutil@4.0.9_typescript@5.9.2_utf-8-validate@5.0.10_zod@3.25.76/node_modules/viem/_esm/utils/rpc/id.js
...
// node_modules/.pnpm/ox@0.9.6_typescript@5.9.2_zod@3.25.76/node_modules/ox/_esm/core/internal/lru.js
...
// node_modules/.pnpm/ox@0.9.6_typescript@5.9.2_zod@3.25.76/node_modules/ox/_esm/core/Caches.js
var caches = {
  checksum: new LruMap2(8192)
};
var checksum = caches.checksum;

// node_modules/.pnpm/ox@0.9.6_typescript@5.9.2_zod@3.25.76/node_modules/ox/_esm/core/Hash.js
...
// node_modules/.pnpm/ox@0.9.6_typescript@5.9.2_zod@3.25.76/node_modules/ox/_esm/core/Address.js
...
// node_modules/.pnpm/ox@0.9.6_typescript@5.9.2_zod@3.25.76/node_modules/ox/_esm/core/Solidity.js
var arrayRegex2 = /^(.*)\[([0-9]*)\]$/;
...
// node_modules/.pnpm/ox@0.9.6_typescript@5.9.2_zod@3.25.76/node_modules/ox/_esm/core/internal/cursor.js
var staticCursor = {
...
// node_modules/.pnpm/ox@0.9.6_typescript@5.9.2_zod@3.25.76/node_modules/ox/_esm/core/AbiParameters.js
...
// node_modules/.pnpm/ox@0.9.6_typescript@5.9.2_zod@3.25.76/node_modules/ox/_esm/erc8010/SignatureErc8010.js
...
function AccountProvider({
  ...
  return (0, import_jsx_runtime3.jsx)(AccountContext.Provider, { value: { account, address }, children });
}
...
function StarknetProvider({
  ...
  return (0, import_jsx_runtime4.jsx)(QueryClientProvider, { client: queryClient ?? defaultQueryClient, children: (0, import_jsx_runtime4.jsx)(StarknetContext.Provider, { value: state, children: (0, import_jsx_runtime4.jsx)(AccountProvider, { address, account, children }) }) });
}
...
function StarknetConfig({ children, ...config }) {
  return (0, import_jsx_runtime5.jsx)(StarknetProvider, { ...config, children });
}
...
function useBalance({
  ...
  const refetchInterval = refetchInterval_ ?? (blockIdentifier === BlockTag.PRE_CONFIRMED && watch ? DEFAULT_FETCH_INTERVAL : void 0);
...
function useCall({
  ...
  const refetchInterval = refetchInterval_ ?? (blockIdentifier === BlockTag.PRE_CONFIRMED && watch ? DEFAULT_FETCH_INTERVAL2 : void 0);
  useInvalidateOnBlock({
    enabled: Boolean(enabled && watch),
    queryKey: queryKey_
  });
...
function useContractFactory({
  ...
  const deployContract2 = (0, import_react11.useCallback)(
    async (options) => {
      if (!account) {
  ...
  return {
    deployContract: account && (compiledContract && casm || classHash) ? deployContract2 : void 0
  };
}
...
//# sourceMappingURL=chunk-3SVM3EVW.js.map
