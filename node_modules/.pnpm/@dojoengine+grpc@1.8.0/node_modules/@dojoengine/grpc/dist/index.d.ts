...
declare class ActivityQuery$Type extends MessageType<ActivityQuery> {
    constructor();
 ...
 */
declare const ActivityQuery: ActivityQuery$Type;
...
declare class AggregationQuery$Type extends MessageType<AggregationQuery> {
    constructor();
 ...
 */
declare const AggregationQuery: AggregationQuery$Type;
...
declare class ToriiGrpcClient {
    ...
    onEntityUpdated(clause: Clause | null | undefined, callback: Function, worldAddresses?: string[]): Promise<Subscription>;
    updateEntitySubscription(subscription: Subscription, clause?: Clause | null, worldAddresses?: string[]): Promise<void>;
    onEventMessageUpdated(clause: Clause | null | undefined, callback: Function, worldAddresses?: string[]): Promise<Subscription>;
    updateEventMessageSubscription(subscription: GrpcSubscription | Subscription, clause?: Clause | null, worldAddresses?: string[]): Promise<void>;
