...
export function useSubscribeObjectives(params = {}) {
    ...
    const { initializeStore, updateEntity, isInitialized, getObjectivesByFilter, getObjectiveData, getObjectivesForGame, } = useObjectivesStore();
