import { RawArgs, Calldata, CairoOption, CairoCustomEnum, RpcProvider, Contract, Account, AccountInterface, AllowArray, Call, UniversalDetails, InvokeFunctionResponse, CallResult, CallContractResponse, TypedData } from 'starknet';
import { z } from 'zod';
...
type DojoActionMethod<Fn> = DojoActionInputs<Fn> extends undefined ? (account: Account | AccountInterface) => Promise<InvokeFunctionResponse> : (account: Account | AccountInterface, args: DojoActionInputs<Fn>) => Promise<InvokeFunctionResponse>;
