...
import { AggregationQuery, AggregationEntry, Aggregations, ActivityQuery, Activity, Activities, Query, PaginationDirection, Clause, OrderBy, Pagination as Pagination$2, Entity } from '@dojoengine/torii-wasm/types';
...
interface SDK<T extends SchemaType> {
     ...
     */
    onAggregationsUpdated: (query: AggregationQueryInput, callback: (entry: AggregationEntryView, subscriptionId: bigint) => void) => Promise<torii.Subscription>;
    /**
     * Updates an existing aggregations subscription.
     */
    updateAggregationsSubscription: (subscription: torii.Subscription, query?: AggregationQueryInput) => Promise<void>;
    /**
     ...
     */
    onActivitiesUpdated: (query: ActivitySubscriptionQuery, callback: (activity: ActivityEntry, subscriptionId: bigint) => void) => Promise<torii.Subscription>;
    /**
     * Updates an existing activities subscription.
     */
    updateActivitiesSubscription: (subscription: torii.Subscription, query?: ActivitySubscriptionQuery) => Promise<void>;
    /**
...
export { generateTypedData as $, type AggregationQueryInput as A, type SqlQueryValue as B, ClauseBuilder as C, type SubscribeParams as D, type SubscribeResponse as E, type SubscribeTokenBalanceRequest as F, type GetParams as G, HashedKeysClause as H, type SubscribeTokenRequest as I, type SubscriptionCallback as J, KeysClause as K, type SubscriptionCallbackArgs as L, MemberClause as M, NO_ACCOUNT as N, OrComposeClause as O, Pagination as P, type ToriiResponse as Q, type UnionOfModelData as R, type SchemaType as S, ToriiQueryBuilder as T, UNDEFINED_CLAUSE as U, type UpdateTokenBalanceSubscriptionRequest as V, convertToPrimitive as W, deepMerge as X, defaultToken as Y, defaultTokenBalance as Z, defaultToriiPagination as _, type StandardizedQueryResult as a, getModel as a0, getModelByEntityId as a1, getTokenBalances as a2, getTokenContracts as a3, getTokens as a4, isCairoCustomEnum as a5, isCairoOption as a6, mergeCairoCustomEnum as a7, mergeCairoOption as a8, onTokenBalanceUpdated as a9, onTokenUpdated as aa, parseEntities as ab, parseTokenRequest as ac, safeCallback as ad, subscribeQueryModelCallback as ae, subscribeToken as af, subscribeTokenBalance as ag, updateTokenBalanceSubscription as ah, type SDKConfig as b, type AggregationsPage as c, type AggregationEntryView as d, type ActivityQueryInput as e, type ActivitiesPage as f, type ActivitySubscriptionQuery as g, type ActivityEntry as h, type SqlQueryResponse as i, type SDK as j, AndComposeClause as k, type AttributesFilter as l, type ContractType as m, type GetTokenBalanceRequest as n, type GetTokenContracts as o, type GetTokenRequest as p, HistoricalToriiQueryBuilder as q, type HistoricalToriiQueryBuilderOptions as r, type MemberValueParam as s, type MergedModels as t, NO_IDENTITY as u, NO_SIGNER as v, type ParsedEntity as w, type SDKClientConfig as x, type SDKFunctionOptions as y, type SqlQueryIntegerValue as z };
